...
class FindFragment : Fragment() {
    ...
    private fun setupAdapter() {
        ...
        val adapter = FindResultsListAdapter()
        adapter.locationList = LocationsTempAccess.getLocations()
    ...
    override fun onCreateView(
        ...
        fragmentView = inflater.inflate(R.layout.fragment_find, container, false)
        updateView()
        return fragmentView
    }
